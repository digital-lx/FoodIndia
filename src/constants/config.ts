...
export const paypalConfig = {
  clientID:
    'ASeBJ9bCrvohepuH5VenGv8tjqi_5auLrIZg40-vaOrfPsYjD_93cGzdxaXwS-IKz1gjIjl9xyEfE6W3',
  secret:
    'EPTjLlM-KgVxRs0jw8IhGq5u9yNT4J5VvJjHwBS7d9vEWCM6vx0kRq2zo76w91IpzLbBnw0PWNWt92Ca',
};

export const URL = 'https://siapmart.in/api';
export const logoURL =
  'http://www.vyaparexpress.co/wp-content/uploads/2017/06/Vyapar-Express-icon.png';
